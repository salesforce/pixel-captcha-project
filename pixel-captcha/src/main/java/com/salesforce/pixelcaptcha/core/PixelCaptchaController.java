...
//		p.setProperty("challengeCount", "4");
//		p.setProperty("responseCount", "12");
...
//        }
    ...
    private void debugInfo(CaptchaMetadata cmd, String id) throws IOException {
        String home = System.getProperty("user.home");
        String fname = home + "/captchasamples/captcha_details.txt";
        System.out.println(fname);
//        File file = new File(fname);
//        if(!file.exists()) {
//            file.createNewFile();
//        }
        String s = createPointString(cmd, id);
